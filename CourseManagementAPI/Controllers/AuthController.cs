...
namespace CourseManagementAPI.Controllers {
    ...
    public class AuthController : ControllerBase {
        ...
        public AuthController(UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, MailService mailService, IConfiguration config)
        {
        ...
        public async Task<IActionResult> Login([FromBody] LoginRequest req)
        {
            ...
            if (user == null)
            {
                return Unauthorized(new { Errors = new[] { "Invalid email and/or password." } });
            }
